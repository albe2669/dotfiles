{
  ...
  inputs = {
    ...
    nixpkgs.url = "github:nixos/nixpkgs/nixos-26.05"; # Use stable for now
    ...
    preflight = {
      url = "git+https://github.com/albe2669/preflight?rev=2193f62225aff83df547f12197b53562266a0857";
      inputs.nixpkgs.follows = "nixpkgs";
    };
  };
